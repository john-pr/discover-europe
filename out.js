...
(0, _jquery2.default)(function () {
    var countries = (0, _jquery2.default)('path');
    // const countryName = $('.countryName');
    var countryDiv = (0, _jquery2.default)('.countryInfo');
    var cntryName = (0, _jquery2.default)('.countryName');
    var cntryCurrency = (0, _jquery2.default)('.countryCurrency');
    var cntryCapital = (0, _jquery2.default)('.countryCapital');
    var cntryTimezone = (0, _jquery2.default)('.countryTimezone');
    var cntryConversion = (0, _jquery2.default)('.countryConversion');
    var cntryVaccination = (0, _jquery2.default)('.countryVaccination');
    var cntryVaccinationInfo = (0, _jquery2.default)('.countryVaccinationInfo');
    // let cntryMoreInfoVacc = $('.vaccination');
    var cntrySocketsInfo = (0, _jquery2.default)('.countrySockets');
    var socketImage = (0, _jquery2.default)('.socketImg');
    var vacneed = (0, _jquery2.default)('.vacNeed');
    var vacfor = (0, _jquery2.default)('.vacFor');
    var cntryNumber = (0, _jquery2.default)('.countryNumber');
    var cntryPolice = (0, _jquery2.default)('.policeLogo');
    var cntryFire = (0, _jquery2.default)('.fireLogo');
    var cntryHospital = (0, _jquery2.default)('.medicLogo');
    var vacNoNeed = (0, _jquery2.default)('.vacNoNeed');
    var cancelBtn = (0, _jquery2.default)('.fa-times-circle');
    ...
    countries.each(function (index, element) {
        (0, _jquery2.default)(element).on('click', function (event) {
            ...
            var currCountry = event.target.getAttribute('name');
            ...
            var countriesUrl = 'https://travelbriefing.org/' + currCountry + '?format=json';
            _jquery2.default.ajax(countriesUrl).done(function (data) {
                var countriesInformation = JSON.parse(data);
                ...
                var plugs = countriesInformation.electricity.plugs;
                socketImage.html('');
            ...
            var restCountries = 'https://restcountries.eu/rest/v2/name/' + currCountry;
            _jquery2.default.ajax(restCountries).done(function (data1) {
                // console.log(data1);
                for (var i = 0; i < data1.length; i++) {
                    var cntryFlag = (0, _jquery2.default)('.countryFlag');
                    cntryFlag.attr('src', data1[i].flag);
                    cntryCapital.text(data1[i].capital);

                    // console.log(data1[i].timezones);

                    var data1Currency = data1[i].currencies;
    ...
    var allDivs = (0, _jquery2.default)('.countryInfo_list');
    var prevBtn = (0, _jquery2.default)('.fa-chevron-left');
    var nextBtn = (0, _jquery2.default)('.fa-chevron-right');
    var counterDiv = 0;
